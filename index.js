// Project work started from 190 line
...
var clotheCollection = document.getElementById("clothe-collection");
var accessoriesCollection = document.getElementById("accessories-collection");
...
for (i = 0; i < productList.length; i++) {
  ...
  // clotheCollection.appendChild(card);
